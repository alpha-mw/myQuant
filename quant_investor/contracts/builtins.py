...
_FACTOR_IDENTITIES: Final = {
    ...
    "factor.production_observation": "factor_production_observation_id",
}
...
_INTELLIGENCE_SPECS: Final = {
    ...
    "daily_research_selected_symbols": (
        "selection_id",
        _RESEARCH_COMMON_FIELDS
        | {
            "ordered_symbols",
    ...
    "daily_research_pool_manifest": (
        ...
        | {
            ...
            "common_symbol_set_sha256",
            "expected_leaf_names",
            "factor_admission_route",
            "factor_generation_ref",
            "factor_pointer_sha256",
            "factor_research_pool",
            "observation_refs",
            "policy_byte_sha256",
            "policy_path",
            "policy_ref",
            ...
            "rank_byte_sha256",
            "rank_ref",
            "selected_symbols_byte_sha256",
            "selected_symbols_ref",
            "selected_symbol_set_sha256",
            "signal_date",
            "strategy_id",
            "technology_gate",
            "technology_shortlist",
            "theme_gate_executed",
        },
    ),
    "daily_research_pool_receipt": (
        "receipt_id",
        _RESEARCH_COMMON_FIELDS
        | {
