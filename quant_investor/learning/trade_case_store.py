...
from quant_investor.versioning import TRADE_CASE_SCHEMA_VERSION


_LEGACY_TRADE_CASE_SCHEMA_VERSION = "trade_case.v1"
...
def _trade_case_from_payload(payload: dict[str, Any]) -> TradeCase:
    ...
    if schema_version not in {TRADE_CASE_SCHEMA_VERSION, _LEGACY_TRADE_CASE_SCHEMA_VERSION}:
    ...
    return TradeCase(
        ...
        schema_version=TRADE_CASE_SCHEMA_VERSION,
    )
