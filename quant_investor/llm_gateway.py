...
from quant_investor.llm_gateway_types import (
    LLMCallError,
    LLMModelPricing,
...
from quant_investor.llm_gateway_parsing import (
    extract_usage as _extract_usage,
    parse_json_content,
    parse_openai_response as _parse_openai_response,
)
...
class LLMClient:
    ...
    _parse_json_content = staticmethod(parse_json_content)
