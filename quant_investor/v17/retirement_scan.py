"""Hash-bound, inventory-stable scanner for the v17 retirement cutover."""
...
from quant_investor.v17.retirement import REQUIRED_SCHEDULE_NAMES

ALLOWLIST_SCHEMA = "v17-retirement-scan-allowlist.v1"
RUNTIME_EVIDENCE_SCHEMA = "v17-retirement-runtime-evidence.v1"
SCAN_REPORT_SCHEMA = "v17-retirement-scan-report.v1"
...
SCHEDULE_LOGICAL_PATHS = {
    name: f"external/schedules/{name}.toml" for name in REQUIRED_SCHEDULE_NAMES
}
