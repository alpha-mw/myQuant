...
class Config:
    ...
    THEME_SCANNER_ENABLED: bool = _env_bool('THEME_SCANNER_ENABLED', False)
    ...
    THEME_SNAPSHOT_ENABLED: bool = _env_bool('THEME_SNAPSHOT_ENABLED', False)
    ...
    THEME_FUNNEL_BOOST_ENABLED: bool = _env_bool('THEME_FUNNEL_BOOST_ENABLED', False)
    ...
    THEME_RISK_GUARD_ENABLED: bool = _env_bool('THEME_RISK_GUARD_ENABLED', False)
    ...
    THEME_PORTFOLIO_CAP_ENABLED: bool = _env_bool('THEME_PORTFOLIO_CAP_ENABLED', False)
