...
from quant_investor.macro_terminal_types import (
    AnalysisStep,
    DataAcquisitionStep,
    IndicatorResult,
    ModuleResult,
...
__all__ = [  # noqa: F822 - USMacroRiskTerminal is provided by module-level __getattr__.
    "AnalysisStep",
    "CNMacroRiskTerminal",
    "DataAcquisitionStep",
    "IndicatorResult",
...
def __getattr__(name: str):
    if name == "USMacroRiskTerminal":
        from quant_investor.macro_terminal_us import USMacroRiskTerminal
