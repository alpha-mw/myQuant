...
from quant_investor.contracts import PortfolioStrategy, ResearchPipelineResult, UnifiedDataBundle
...
def main() -> None:
    ...
    parser.add_argument(
        "--kline-backend", default="hybrid", choices=["heuristic", "kronos", "chronos", "hybrid"],
