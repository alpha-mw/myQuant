...
class QuantInvestor:
    ...
    def _run_research_core(
        self,
    ) -> ParallelResearchPipeline.ResearchCoreSnapshot:
        ...
        pipeline.enable_agent_orchestrator_bridge = False
        if hasattr(pipeline, "run_research_core"):
            return pipeline.run_research_core()
    ...
    def _run_review_layer(
        self,
        snapshot: ParallelResearchPipeline.ResearchCoreSnapshot,
