...
THEME_PROVIDER_PLAN_VERSION: Final = "myquant.v17.intelligence-v2.tushare-theme-provider-plan.v1"
THEME_PARTITION_VERSION: Final = "myquant.v17.intelligence-v2.tushare-theme-partition.v1"
THEME_PROVIDER_CAPTURE_VERSION: Final = (
    "myquant.v17.intelligence-v2.tushare-theme-provider-capture.v1"
)
...
def build_theme_provider_execution_plan(
    *,
    ...
    return seal(
        {
            "version": THEME_PROVIDER_PLAN_VERSION,
...
def validate_theme_provider_execution_plan(document: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if value.get("version") != THEME_PROVIDER_PLAN_VERSION:
        _fail("theme provider plan version mismatch")
...
def _build_theme_partition_capture(
    *,
    ...
    return seal(
        {
            "version": THEME_PARTITION_VERSION,
...
def _validate_theme_partition_capture(
    ...
    *,
    ...
    if value.get("version") != THEME_PARTITION_VERSION:
        _fail("theme partition version mismatch")
...
def build_theme_provider_capture(
    *,
    ...
    return seal(
        {
            "version": THEME_PROVIDER_CAPTURE_VERSION,
...
def validate_theme_provider_capture(
    ...
    *,
    ...
    if value.get("version") != THEME_PROVIDER_CAPTURE_VERSION:
        _fail("theme provider capture version mismatch")
...
__all__ = [
    "THEME_PARTITION_VERSION",
    "THEME_PROVIDER_CAPTURE_VERSION",
    "THEME_PROVIDER_PLAN_VERSION",
