...
INDUSTRY_TAXONOMY_PLAN_KIND: Final = "market.tushare.industry_taxonomy_plan"
INDUSTRY_TAXONOMY_CAPTURE_KIND: Final = "market.tushare.industry_taxonomy_capture"
INDUSTRY_MEMBERSHIP_PLAN_KIND: Final = "market.tushare.industry_membership_plan"
...
def build_industry_taxonomy_execution_plan(
    *,
    ...
    return seal(
        {
            "kind": INDUSTRY_TAXONOMY_PLAN_KIND,
...
def validate_industry_taxonomy_execution_plan(
    ...
    if value.get("kind") != INDUSTRY_TAXONOMY_PLAN_KIND:
        _fail("industry taxonomy execution plan kind mismatch")
...
def build_industry_taxonomy_capture(
    *,
    ...
    return seal(
        {
            "kind": INDUSTRY_TAXONOMY_CAPTURE_KIND,
...
def validate_industry_taxonomy_capture(
    ...
    *,
    ...
    if value.get("kind") != INDUSTRY_TAXONOMY_CAPTURE_KIND:
        _fail("industry taxonomy capture kind mismatch")
...
def build_industry_membership_execution_plan(
    *,
    ...
    return seal(
        {
            "kind": INDUSTRY_MEMBERSHIP_PLAN_KIND,
            **common_fields(timestamp_value=created),
            "created_at": created,
...
def validate_industry_membership_execution_plan(
    ...
    *,
    ...
    if value.get("kind") != INDUSTRY_MEMBERSHIP_PLAN_KIND:
        _fail("industry membership plan kind mismatch")
...
__all__ = [
    ...
    "INDUSTRY_TAXONOMY_CAPTURE_KIND",
    "INDUSTRY_TAXONOMY_PLAN_KIND",
    "INDUSTRY_MEMBERSHIP_PLAN_KIND",
    "OFFICIAL_PARTITIONS",
