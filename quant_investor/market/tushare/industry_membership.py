...
INDUSTRY_MEMBERSHIP_PARTITION_KIND: Final = "market.tushare.industry_membership_partition"
INDUSTRY_MEMBERSHIP_CAPTURE_KIND: Final = "market.tushare.industry_membership_capture"
...
def build_industry_membership_capture(
    *,
    ...
    return seal(
        {
            "kind": INDUSTRY_MEMBERSHIP_CAPTURE_KIND,
...
def validate_industry_membership_capture(
    ...
    *,
    ...
    if value.get("kind") != INDUSTRY_MEMBERSHIP_CAPTURE_KIND:
        _fail("industry membership capture kind mismatch")
...
__all__ = [
    ...
    "INDUSTRY_MEMBERSHIP_CAPTURE_KIND",
    "INDUSTRY_MEMBERSHIP_PARTITION_KIND",
