...
assert.match(html, /js\/cn_aggressive_dashboard_contract_v1\.js\?v=dashboard-v3/);
assert.match(publicHtml, /js\/cn_aggressive_dashboard_contract_v1\.js\?v=dashboard-v3/);
assert.doesNotMatch(html, /js\/cn_aggressive_dashboard_contract_v1\.js\?v=dashboard-v2/);
assert.doesNotMatch(publicHtml, /js\/cn_aggressive_dashboard_contract_v1\.js\?v=dashboard-v2/);
assert.match(html, /app\.js\?v=dashboard-v7/);
assert.match(publicHtml, /app\.js\?v=dashboard-v7/);
assert.doesNotMatch(html, /app\.js\?v=dashboard-v6/);
assert.doesNotMatch(publicHtml, /app\.js\?v=dashboard-v6/);
...
assert.match(app, /function publicBundleDataUpdated\(bundle\)/);
assert.match(app, /bundle\.latest_data_date === performanceEnd/);
