...
def test_package_runtime_manifests_and_scaffold_authority_are_sealed() -> None:
    ...
    assert set(verify_runtime_build()) == {
        ...
        "v17_v4_runtime/cli_provisional.py",
        ...
        "v17_v4_runtime/provisional_forward.py",
        "v17_v4_runtime/public_surfaces.py",
        "v17_v4_runtime/regime_evidence_v2.py",
        "v17_v4_runtime/regime_evidence_v3.py",
        ...
        "v17_v4_runtime/source_builder.py",
    ...
    assert set(verify_forward_runtime_sources()) == {
        ...
        "research/_artifacts.py",
        "research/label_maturity.py",
        "research/research_experiment_registry/__init__.py",
        "research/research_experiment_registry/store.py",
        "research/research_memory/__init__.py",
        "research/research_memory/store.py",
        "research/research_scheduler.py",
