...
import quant_investor.v17.retirement_scan as scan_module
from quant_investor.v17.retirement import REQUIRED_SCHEDULE_NAMES
from quant_investor.v17.retirement_scan import (
    ALLOWLIST_SCHEMA,
...
def _external_files(
    tmp_path: Path,
    *,
    skill_payload: bytes = b"installed skill points to v17 shadow\n",
...
def test_clean_scan_binds_exact_external_and_runtime_evidence(tmp_path: Path) -> None:
    ...
    (repo / "safe.py").write_text("VALUE = 'v17'\n", encoding="utf-8")
